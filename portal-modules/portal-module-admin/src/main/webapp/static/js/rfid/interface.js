...
var SmartReader={
    OBJ:function(){
        ...
        var WSonError=function(){
            console.log("Reader Server not running");
        };
		...
		reader.tagSetPwd=function(hdev,tagType,pwd,protectType,startAddrToProtect,maxErrorVerify,lockConfig){SendCmd("tagSetPwd",FUNCIDS._fid_tagSetPwd,hdev+","+tagType+","+pwd+","+protectType+","+startAddrToProtect+","+maxErrorVerify+","+lockConfig);};
		reader.tagAuthenPwd=function(hdev,pwd){SendCmd("tagAuthenPwd",FUNCIDS._fid_tagAuthenPwd,hdev+","+pwd);};
      ...
      hdev+","+cardType);};
		...
		reader.getAutoReturnData=function(hdev){SendCmd("getAutoReturnData", FUNCIDS._fid_getAutoReturnData, hdev);};
